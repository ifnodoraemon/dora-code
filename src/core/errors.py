...
class TransientError(PolymathException):
    ...
    def __init__(self, message: str, retry_after: float = 1.0, context: Optional[dict] = None):
...
class RateLimitError(PolymathException):
    ...
    def __init__(self, message: str, retry_after: float = 60.0, context: Optional[dict] = None):
...
class ErrorHandler:
    ...
    def handle(self, exception: Exception, context: Optional[dict] = None) -> ErrorInfo:
        """
