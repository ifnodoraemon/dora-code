...
from typing import (
    TypeVar, Generic, Callable, Dict, Any, Optional, Type, 
    get_type_hints, Union, Protocol
)
...
class ServiceCollection:
    ...
    def add_singleton(
        self, 
        service_type: Type[T], 
        implementation: Optional[Union[Type[T], T, Callable[[], T]]] = None
    ) -> 'ServiceCollection':
        """
...
_global_services: Optional[DefaultServiceProvider] = None
