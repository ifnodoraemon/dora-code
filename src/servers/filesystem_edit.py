"""
Filesystem Edit Operations Module

Provides file editing operations:
- edit_file: Replace content in a file
- edit_file_multiline: Apply multiple edits in sequence
"""
...
mcp = FastMCP("DoraemonFilesystemEdit")
